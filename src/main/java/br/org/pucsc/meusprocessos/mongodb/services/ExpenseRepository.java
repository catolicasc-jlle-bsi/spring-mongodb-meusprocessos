...
import br.org.pucsc.meusprocessos.model.State;
...
public class ExpenseRepository implements ExpenseService {
	...
	public Long createExpense(String description, ExpenseType expenseType, Date expenseDate, Double amount, User user, Attachment attachment) {
	...
	public Expense getExpense(Long expenseId) {
		// List<Expense> expenseList = mongoTemplate.find(new
		// Query(Criteria.where("expenseId").is(expenseId)),Expense.class,EXPENSE_COLLECTION_NAME);

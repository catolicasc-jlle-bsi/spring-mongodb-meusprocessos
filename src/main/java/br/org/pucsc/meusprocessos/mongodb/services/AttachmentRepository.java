...
public class AttachmentRepository implements AttachmentService {
	...
	public Attachment getAttachment(Long attachmentId) {
		List<Attachment> attachmentList = mongoTemplate.find(new Query(Criteria.where("attachmentId").is(attachmentId)), Attachment.class, ATTACHMENT_COLLECTION);
	...
	public List<Attachment> getAttachmentByExpenseId(Long expenseId) {
		List<Attachment> attachmentList = mongoTemplate.find(new Query(Criteria.where("expenseId").is(expenseId)), Attachment.class, ATTACHMENT_COLLECTION);

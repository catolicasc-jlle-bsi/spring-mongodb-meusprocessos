          ...
          <ul class="nav nav-sidebar">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="panel panel-default">
					...
					<div class="panel-heading"><a class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/employee/new">Novo Funcionário</a></div>
						...
						<tbody>						
							<c:forEach var="employee" items="${employees}">
								<tr>
									...
									<td><a class="btn btn-danger btn-sm" href="${pageContext.request.contextPath}/employee/read?id=${employee.id}">Editar</a></td>
								</tr>
							</c:forEach>						
						</tbody>
					</table>

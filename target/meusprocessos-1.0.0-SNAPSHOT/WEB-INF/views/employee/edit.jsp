					...
					<div class="container">
						<div class="col-md-8" style="margin-top: 20px;">			
							...
							<form action="${pageContext.request.contextPath}/employee/save"
								...
								<input value="${employee.id}" type="hidden" name="id" />
								
								<div class="row">
									<div class="form-group">
										<label for="name">Nome</label> <input value="${employee.name}" type="text"
								...
								<div class="row">
									<div class="form-group">
										<label for="cnpj">CNPJ/CPF</label> <input value="${employee.cnpj}" type="text"
								...
								<div class="row">
									<div class="form-group">
										<label for="cnpj">Registro OAB</label> <input value="${employee.oabNumber}" type="text"
											class="form-control" id="cnpj"
											placeholder="Escreva o número do registro da OAB aqui" name="oabnumber"
											required="required" size="30">
									</div>
								</div>
								<div class="row">
									<div class="form-group">
										<label for="email">E-mail</label> <input value="${employee.email}" type="email"
								...
								<div class="row">
									<div class="form-group">
										<label for="phone">Fone</label> <input value="${employee.phone}" type="text"
								...
								<div class="row">
									<div class="form-group">
										...
										<textarea class="form-control" id="observation"
											name="observation">${employee.observation}</textarea>
									</div>
								</div>
								<div class="row">
